...
router.register(r"athletes", api.AthletViewSet)
router.register(r"scientists", api.ScientistViewSet)
router.register(r"musical-genres", api.MusicalGenreViewSet)
router.register(r"occupations", api.OccupationViewSet)
router.register(r"movie-genres", api.MovieGenreViewSet)
